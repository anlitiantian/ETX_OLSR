...
namespace ns3
{
    namespace olsr
    {
        ...
        void OlsrState::InsertNeighborTuple(NeighborTuple const &tuple)
        {
            for (NeighborSet::iterator it = m_neighborSet.begin();
                 it != m_neighborSet.end(); it++)
            {
        ...
        NeighborTuple *OlsrState::InsertOrUpdateNeighborTuple(NeighborTuple const &tuple)
        {
