...
_wrap_PyNs3BuildingsHelper_MakeConsistent(PyNs3BuildingsHelper *PYBINDGEN_UNUSED(dummy), PyObject *args, PyObject *kwargs)
{
    ...
    ns3::BuildingsHelper::MakeConsistent(ns3::Ptr< ns3::MobilityModel  > (mm_ptr));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
PyObject *
_wrap_PyNs3BuildingsHelper_MakeMobilityModelConsistent(PyObject *PYBINDGEN_UNUSED(_self), PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
...
static PyMethodDef PyNs3BuildingsHelper_methods[] = {
    ...
    {(char *) "MakeConsistent", (PyCFunction) _wrap_PyNs3BuildingsHelper_MakeConsistent, METH_KEYWORDS|METH_STATIC|METH_VARARGS, "MakeConsistent(mm)\n\ntype: mm: ns3::Ptr< ns3::MobilityModel >" },
...
PyObject *
_wrap_PyNs3MobilityBuildingInfo_IsOutdoor(PyNs3MobilityBuildingInfo *self, PyObject *PYBINDGEN_UNUSED(_args), PyObject *PYBINDGEN_UNUSED(_kwargs))
{
    PyObject *py_retval;
    bool retval;
