...
namespace ns3
{
    namespace olsr
    {
        ...
        protected:
            ...
            std::map<Ipv4Address, uint32_t> m_HelloReceived; // Hello message number received

            LinkQosSet m_linkQosSet;

        public:
            OlsrState()
            {
            }
            std::map<Ipv4Address, uint32_t> GetHelloReceived()
            {
                return m_HelloReceived;
            }
            void setHelloReceived(std::map<Ipv4Address, uint32_t> helloMap)
            {
                m_HelloReceived = helloMap;
            }
            // -----------------------------------------------------MPR selector
             ...
             * \param tuple The neighbor tuple.
             */
            NeighborTuple *InsertOrUpdateNeighborTuple(const NeighborTuple &tuple);
            ...
            const LinkQosSet &GetLinkQosSet() const
            {
                return m_linkQosSet;
            }
