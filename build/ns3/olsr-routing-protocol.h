...
namespace ns3
{
    namespace olsr
    {
        ...
        struct RoutingTableEntry                                                // 存接口地址
        {
            ...
            uint32_t etxDistance;     //!< Distance in sum Etx to the destination.
        ...
        private:
             ...
             * \param etxDistance distance in etx to the destination node.
             */
            void AddEntry(const Ipv4Address &dest,
                          const Ipv4Address &next,
                          uint32_t interface,
                          uint32_t distance,
                          uint32_t etxDistance);
            /**
             * \brief Adds a new entry into the routing table.
             *
        ...
        private:
            ...
            /**
             * 当收到hello包时，发送helloAck确认包
             * \param messageHeader  接收到的hello包的MessageHeader
             * \param receiverIfaceAddr 待接收的接口地址
             * \param senderIfaceAddr 待发送的接口地址
             *
             */
            void SendHelloAck(const MessageHeader &messageHeader, Ipv4Address receiverIfaceAddr, Ipv4Address senderIfaceAddr);
             ...
             */
            NeighborTuple *LinkTupleAdded(const LinkTuple &tuple, uint8_t willingness);
             ...
             */
            NeighborTuple *AddNeighborTuple(const NeighborTuple &tuple);
             ...
             *
             */
            void ProcessHelloAck(const olsr::MessageHeader &msg, const Ipv4Address &receiverIface,
                                 const Ipv4Address &senderIface);
