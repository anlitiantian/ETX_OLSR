...
int main(int argc, char *argv[])
{
  ...
  LogComponentEnable ("SimpleGlobalRoutingExample", LOG_LEVEL_INFO);
    ...
    OnOffHelper onoff1("ns3::UdpSocketFactory",
                       InetSocketAddress(i45.GetAddress(1), port));
    ...
    ApplicationContainer onOffApp2 = onoff2.Install(c.Get(4));
    ...
    NodeContainer sinks = NodeContainer(c.Get(5), c.Get(1));
    ...
    //   AnimationInterface anim("simple-point-to-point-olsr.xml");
    Simulator::Run();
    Simulator::Destroy();
    NS_LOG_INFO("Done.");
